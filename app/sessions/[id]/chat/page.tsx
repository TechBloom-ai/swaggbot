      ...
      <header className='border-b border-[var(--color-border)] bg-white px-4 py-3'>
        <div className='mx-auto flex max-w-4xl items-center justify-between'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              <h1 className='font-semibold text-[var(--color-logic-navy)]'>{session.name}</h1>
              <p className='text-xs text-[var(--color-text-secondary)]'>{session.swaggerUrl}</p>
            </div>
          </div>
        ...
        <div className='mx-auto max-w-4xl space-y-6'>
          {messages.length === 0 ? (
            <div className='flex flex-col items-center justify-center py-12 text-center'>
              ...
              <h2 className='mt-4 text-xl font-semibold text-[white]'>Welcome to Swaggbot</h2>
